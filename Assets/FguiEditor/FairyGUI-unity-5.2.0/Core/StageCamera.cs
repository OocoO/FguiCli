...
namespace FairyGUI
{
    ...
    {
        public static Vector3 StageOffset = Vector3.up * 100f;
        /// <summary>
        /// 
        /// </summary>
        ...
        void OnScreenSizeChanged(int newWidth, int newHeight)
        {
            ...
            cachedTransform.localPosition = new Vector3(cachedCamera.orthographicSize * screenWidth / screenHeight, -cachedCamera.orthographicSize) + StageOffset;
